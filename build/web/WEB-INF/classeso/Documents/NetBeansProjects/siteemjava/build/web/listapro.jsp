...
<%
    try {
        ...
        */
        //Inserindo comando SQL para selecionar a tabela
        ...
        */
        ...
        /*
        O código abaixo serve para fazer com que seja exibido os elementos
        cadastrados no banco de dados. O rs precisa passar linha por linha,
        portanto se tiver 10000 produtos nesse caso, ele deverá passar por
        todos. E é nessas ocasiões que utilizamos laços de repetição. Enquanto
        tiver valor na variável rs, pegue o valor e passe para a próxima (next) linha.
        */
%>
    <table>
        <thead>
